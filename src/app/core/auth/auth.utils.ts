...
export class AuthUtils
{
     ...
     * @param offsetSeconds
     */
    static isTokenExpired(expiry: string, offsetSeconds?: number): boolean
    {

        // Get the expiration date
        const date = this._getTokenExpirationDate(expiry);
     ...
     * @private
     */
    private static _getTokenExpirationDate(expires: string): Date | null
    {
        // Convert the expiration date
        const date = new Date(0);
        date.setUTCSeconds(Number(expires));
